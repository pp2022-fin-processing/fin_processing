...
@dataclass
class AlphaVantageNewsAndSentimentsAPIProvider:
    api_key_v: str
    ...
    def get_news_and_sentiment(self, symbols: Optional[Sequence[Symbol]] = None,
                               ...
                               limit: Optional[int] = 50, sort: Optional[str] = 'LATEST'):
        ...
        time_from_v = None if not date_start else date_start.strftime('YYYYMMDDTHHMM')
        time_to_v = None if not date_end else date_end.strftime('YYYYMMDDTHHMM')
